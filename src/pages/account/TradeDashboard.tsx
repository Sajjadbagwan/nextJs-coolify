...
const tiles = [
  ...
  { to: "/trade/apply-credit", label: "Apply for Credit Account", icon: CreditCard, desc: "Upgrade to credit terms" },
];

const TradeDashboard = () => {
  return (
    <AccountLayout title="Hi Stuart, welcome back" eyebrow="Trade Account">
      <div className="px-4 pt-5 pb-8">
        <p className="text-[14px] text-muted-foreground leading-relaxed mb-5">
          From your trade dashboard you can view recent orders, manage addresses,
          and apply for a credit account.
        </p>

        {/* Quick stats */}
        <div className="grid grid-cols-3 gap-2 mb-6">
          <Link to="/account/orders" className="bg-[hsl(var(--brand-bg))] rounded-lg p-3 active:scale-[0.98] transition-transform">
            <div className="font-heading text-2xl text-[hsl(var(--brand-dark))] font-medium">24</div>
          ...
          <Link to="/account/loyalty" className="bg-[hsl(var(--brand-bg))] rounded-lg p-3 active:scale-[0.98] transition-transform">
            <div className="font-heading text-2xl text-[hsl(var(--brand-dark))] font-medium">42,500</div>
          ...
          <Link to="/account/favourites" className="bg-[hsl(var(--brand-bg))] rounded-lg p-3 active:scale-[0.98] transition-transform">
            <div className="font-heading text-2xl text-[hsl(var(--brand-dark))] font-medium">15</div>
